...
var Save = func(cfg *config.Config, vmName, role, arch, ip, subnet, ipv6, subnetv6, mac, pxeBootStackTar, dockerImagesPath, vmsPath string, sshPort int, pxeBoot bool) error {
	meta := Metadata{
		Name:             vmName,
		Role:             role,
		Arch:             arch,
