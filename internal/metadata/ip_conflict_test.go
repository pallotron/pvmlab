	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			for vmName, meta := range tt.vms {
				if err := Save(cfg, vmName, meta.Role, meta.IP, meta.Subnet, meta.IPv6, meta.SubnetV6, meta.MAC, meta.PxeBootStackTar, meta.DockerImagesPath, meta.VMsPath, meta.SSHPort); err != nil {
